...
//        return getDefaultWeatherLocation();
    ...
    public static boolean isMetric(Context context) {
        ...
        /** This will be implemented in a future lesson **/
        String unitsValue = PreferenceManager.getDefaultSharedPreferences(context)
                .getString(context.getString(R.string.pref_units_key), context
                .getString(R.string.pref_units_metric));

        return context.getString(R.string.pref_units_metric).equals(unitsValue);
    }
