...
//        }
    ...
    private void loadWeatherData() {
        new ForecastQueryTask().execute(SunshinePreferences.getPreferredWeatherLocation(this));
    }
    ...
    private class ForecastQueryTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... locations) {
            ...
            try {
                ...
                forecastData = OpenWeatherJsonUtils
                        .getSimpleWeatherStringsFromJson(MainActivity.this, responseFromHttpUrl);
