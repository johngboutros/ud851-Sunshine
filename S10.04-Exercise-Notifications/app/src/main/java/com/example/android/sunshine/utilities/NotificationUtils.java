...
//  (1) Create a constant int value to identify the notification
    private static final int TODAY_WEATHER_NOTIFICATION_ID = 876;
    private static final int TODAY_WEATHER_PENDING_INTENT_ID = 114;
    private static final String SUNSHINE_NOTIFICATION_CHANNEL_ID = "sunshine_notification_channel";
...
//          (2) Use NotificationCompat.Builder to begin building the notification
            NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context,
                        SUNSHINE_NOTIFICATION_CHANNEL_ID)
...
//          (4) Use TaskStackBuilder to create the proper PendingIntent
            ...
            PendingIntent resultPendingIntent = taskStackBuilder
                    .getPendingIntent(TODAY_WEATHER_PENDING_INTENT_ID,
...
//          (7) Notify the user with the ID WEATHER_NOTIFICATION_ID
            notificationManager.notify(TODAY_WEATHER_NOTIFICATION_ID, notificationBuilder.build());
